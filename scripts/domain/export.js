...
export function sceneBoardToSvg(board, labels = {}) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}"><style>svg{font-family:Arial,sans-serif;background:#17191f}.connection{stroke:#f6c453;stroke-width:3;fill:none;stroke-linecap:round}.connection-arrow{fill:#f6c453}.connection-label{fill:#f6c453;font-size:12px;font-weight:600;paint-order:stroke;stroke:#17191f;stroke-width:4px;text-anchor:middle}.chapter-connection{stroke:#6ed6a0;stroke-width:2;stroke-dasharray:6 5;fill:none}.chapter-connection-arrow{fill:#6ed6a0}.chapter-connection-label{fill:#6ed6a0;font-size:12px;font-weight:600;paint-order:stroke;stroke:#17191f;stroke-width:4px;text-anchor:middle}.element-frame{fill:#313846;stroke:#c7d2e0;stroke-width:2}.element-frame-inner{fill:none;stroke:#c7d2e0;stroke-width:2}.element text{fill:#f0f0f0}.element-title{font-size:15px;font-weight:600}.element-description,.element-id{fill:#d3dae4;font-size:11px}.element-id{font-family:monospace}.element-status-badge{fill:rgba(246,196,83,.12);stroke:#59687a;stroke-width:1}.element-status{fill:#f6c453;font-size:11px;font-weight:600}.scene-icon{pointer-events:none}${sceneIconColorStyles}.chapter-node-title{fill:#edf2f7;font-size:12px}${statusColorStyles}${shapeStatusStyles}</style>${lines}${chapterConnectionMarkup}${chapterNodeMarkup}${elementMarkup}</svg>`;
}
