...
export function sceneBoardToSvg(board, labels = {}) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}"><style>svg{font-family:Arial,sans-serif;background:#17191f}.connection{stroke:#f6c453;stroke-width:3;fill:none;stroke-linecap:round}.connection-arrow{fill:#f6c453}.connection-label{fill:#f6c453;font-size:12px;font-weight:600;paint-order:stroke;stroke:#17191f;stroke-width:4px;text-anchor:middle}.element rect{fill:#313846;stroke:#c7d2e0;stroke-width:2}.element text{fill:#f0f0f0;font-size:16px}.element text.type,.element text.status{fill:#aeb8c5;font-size:11px}</style>${lines}${elements}</svg>`;
}
